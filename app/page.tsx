...
const Card: React.FC<CardProps> = ({ title, description, imageSrc, imageAlt, link }) => {
  return (
    <a
      href={link}
      className="card bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden cursor-pointer flex flex-col items-center p-6 transform transition-all duration-300 hover:scale-105"
    >
      <img
        src={imageSrc}
        alt={imageAlt}
